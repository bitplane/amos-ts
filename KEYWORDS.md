...
| gui-1.61             |      103 |       65 |           38 |       0 |     100% |
| gui-2.10             |      204 |      134 |           70 |       0 |     100% |
| input                |       18 |       17 |            1 |       0 |     100% |
...
| os-devkit-1.61       |     1047 |      734 |          309 |       4 |     100% |
| p61-1.2              |        9 |        9 |            0 |       0 |     100% |
| palette              |        9 |        9 |            0 |       0 |     100% |
...
- **approximated** (13): `gui amiga`, `gui amos`, `gui asl$`, `gui border`, `gui circle`,
  `gui exist`, `gui iconify`, `gui mouse x`, `gui mouse y`, `gui open`, `gui req`,
  `gui uniconify`, `gui wait`

## gui-1.61 (100%)

- **approximated** (38): `gui amiga`, `gui amos`, `gui asl$`, `gui beep`, `gui border`,
  `gui exist`, `gui gad adr`, `gui iconify`, `gui in height`, `gui in width`, `gui mouse x`,
  `gui mouse y`, `gui open`, `gui read`, `gui req`, `gui uniconify`, `gui wait`, `tcp buffer`,
...
- **approximated** (70): `gui app icon`, `gui app id`, `gui app name$`, `gui app remove`,
  `gui asl open`, `gui asl$`, `gui beep`, `gui best`, `gui border`, `gui clone`,
  `gui display iff`, `gui exist`, `gui gad adr`, `gui guide`, `gui iconify`, `gui in height`,
  `gui in width`, `gui input$`, `gui line 3d`, `gui monitor`, `gui mouse wx`, `gui mouse wy`,
  ...
  `gui pub to back`, `gui pub to front`, `gui read`, `gui rem notify`, `gui remap`, `gui req`,
  `gui save iff`, `gui screen base`, `gui uniconify`, `gui wait`, `tcp abort`, `tcp accept`,
...
- **approximated** (309): `_ag display`, `_ag show`, `_alert`, `_app add icon`, `_app add menu`,
  ...
  `_dt do`, `_event wait port`, `_font add`, `_font ask`, `_font close`, `_font load`,
  `_font open`, `_font rem`, `_fx balance`, `_fx play`, `_gad activate`, `_gad add`,
  `_gad modif prop`, `_gad off`, `_gad on`, `_gad refresh`, `_gad remove`, `_ggad create`,
  `_ggad draw box`, `_ggad refresh`, `_ggad set attrs`, `_ggad what attrs`, `_gmsg get`,
  `_gmsg reply`, `_gt activate`, `_gt add bob item`, `_gt add bob sub`, `_gt add image item`,
  `_gt add image sub`, `_gt add item`, `_gt add menu`, `_gt add sub`, `_gt begin refresh`,
  `_gt bevel box`, `_gt bob`, `_gt boopsi`, `_gt button`, `_gt checkbox`, `_gt create`,
  `_gt cycle`, `_gt disable`, `_gt enable`, `_gt end refresh`, `_gt gadgets attach`,
  `_gt gadgets erase`, `_gt gadgets remove`, `_gt h scroller`, `_gt h slider`, `_gt image`,
  `_gt integer`, `_gt listview`, `_gt make bitmap`, `_gt make image`, `_gt menus attach`,
  `_gt menus erase`, `_gt mx`, `_gt number`, `_gt palette`, `_gt refresh`, `_gt refresh wnd`,
  `_gt set attrs`, `_gt set bob`, `_gt set checkbox`, `_gt set cycle`, `_gt set image`,
  `_gt set integer`, `_gt set listview`, `_gt set mx`, `_gt set number`, `_gt set palette`,
  `_gt set scroller`, `_gt set slider`, `_gt set string`, `_gt set text`, `_gt string`,
  `_gt text`, `_gt v scroller`, `_gt v slider`, `_gt what attr`, `_gt what integer`,
  `_gt what string`, `_icon def`, `_icon get`, `_icon info`, `_icon load`, `_icon put`,
  `_icon save`, `_iff open in`, `_iff open out`, `_iff parse`, `_img draw`, `_img draw state`,
  `_img erase`, `_int add`, `_it print`, `_it what len`, `_joy init`, `_joy read`, `_joy set`,
  `_joy type`, `_key pressed`, `_layer create behind`, `_layer create upfront`, `_layer delete`,
  `_li free`, `_li new`, `_lib close`, `_lib open`, `_lib revision`, `_lib version`,
  `_loc open`, `_loc str`, `_mem avail`, `_mem type`, `_mode best id`, `_mode coerce`,
  `_msg get`, `_obj do`, `_obj new`, `_obj set attrs`, `_pen find`, `_pen obtain`,
  `_pen obtain best`, `_pen release`, `_pen set max`, `_pool alloc`, `_pool create`,
  `_pool delete`, `_pool free`, `_print`, `_ptr clear`, `_ptr set`, `_query overscan`,
  `_req do`, `_req easy`, `_req end`, `_req init`, `_request choice`, `_rfsh begin`,
  `_rfsh end`, `_rgb32 load`, `_rgb32 set`, `_rgb4 load`, `_rgb4 set`, `_rp bf scroll`,
  `_rp clr eol`, `_rp clr scr`, `_rp poly draw`, `_rp scroll`, `_rp set attrs`,
  `_rp what attrs`, `_scale bm`, `_scale div`, `_scr beep`, `_scr close`, `_scr def pub`,
  `_scr dinf free`, `_scr dinf get`, `_scr hide title`, `_scr id beep`, `_scr id clip`,
  `_scr id fill ellipse`, `_scr id fix dri pens`, `_scr id from pointer`, `_scr id from pub`,
  `_scr id open`, `_scr id put bob`, `_scr id scroll`, `_scr id set mouse pos`,
  `_scr id tag open`, `_scr move`, `_scr open`, `_scr position`, `_scr pub lock`,
  `_scr pub modes`, `_scr pub status`, `_scr pub unlock`, `_scr show title`, `_scr tag open`,
  `_scr to back`, `_scr to front`, `_scr what active`, `_scr what front`,
