...
- **faithful** (124): `align`, `amcaf crack off`, `amcaf crack on`, `amos state`, `avail free`,
  ...
  `iff bank`, `image height`, `image swap`, `image width`, `ipk length`, `long`, `long$`,
  `lsl.b`, `lsl.l`, `lsl.w`, `lsr.b`, `lsr.l`, `lsr.w`, `number`, `odd`, `open workbench`,
  `pause`, `pcpn$`, `pcsr$`, `pdef$`, `pinv$`, `pjam$`, `plane active`, `plane clear`,
  ...
  `psad$`, `pund$`, `rastport`, `rs`, `rs aptr`, `rs bset`, `rs byte`, `rs char`, `rs clear`,
...
- **missing** (7): `bpk length`, `bpk unpack`, `dpk name$`, `dpk unpack`, `lpk length`,
  `lpk pack`, `lpk unpack`
