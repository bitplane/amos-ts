...
| os-devkit-1.61       |     1047 |      362 |          174 |     511 |      51% |
| p61-1.2              |        9 |        9 |            0 |       0 |     100% |
| palette              |        9 |        9 |            0 |       0 |     100% |
...
- **approximated** (174): `_area draw`, `_area ellipse`, `_area end`, `_area move`, `_bd draw`,
  ...
  `_gt begin refresh`, `_gt button`, `_gt checkbox`, `_gt cycle`, `_gt disable`, `_gt enable`,
  `_gt end refresh`, `_gt gadgets attach`, `_gt gadgets bank`, `_gt gadgets erase`,
  `_gt gadgets remove`, `_gt h scroller`, `_gt h slider`, `_gt integer`, `_gt listview`,
  `_gt mx`, `_gt number`, `_gt palette`, `_gt refresh`, `_gt refresh wnd`, `_gt set checkbox`,
  `_gt set cycle`, `_gt set integer`, `_gt set integer mode`, `_gt set listview`,
  ...
  `_gt string`, `_gt text`, `_gt v scroller`, `_gt v slider`, `_gt what integer`,
  `_gt what string`, `_img draw`, `_img draw state`, `_img erase`, `_layer create behind`,
