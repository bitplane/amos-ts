...
1204 qualifying notes live in `src/coverage/status.ts`, which this file
...
- **approximated** (9): `db play`, `dme sam freq`, `dme sam play`, `fc13 play`, `fc14 play`,
  `ptm cia speed`, `sfx13 play`, `thx cont`, `thx vu`
- **n/a** (1): `nop`
