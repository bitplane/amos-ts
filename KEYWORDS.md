...
- **missing**: `@_apml_@`, `as`, `drive`, `follow`, `follow off`, `freeze`, `hardcol`, `ldir`, `ldir/w`, `mask iff`, `on break proc`, `picture`, `pload`, `prun`, `read text`, `save`, `save iff`, `set accessory`, `set equate bank`, `set hardcol`, `set stack`, `set tempras`, `unfreeze`
