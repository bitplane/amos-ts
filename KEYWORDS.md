...
| os-devkit-1.61       |     1047 |      362 |          146 |     539 |      49% |
| p61-1.2              |        9 |        9 |            0 |       0 |     100% |
| palette              |        9 |        9 |            0 |       0 |     100% |
...
- **approximated** (146): `_area draw`, `_area ellipse`, `_area end`, `_area move`, `_bd draw`,
  ...
  `_gt gadgets erase`, `_gt gadgets remove`, `_gt integer`, `_gt refresh wnd`,
  `_gt set checkbox`, `_gt set integer`, `_gt set integer mode`, `_gt set mode`,
  `_gt what integer`, `_img draw`, `_img draw state`, `_img erase`, `_layer create behind`,
