...
| os-devkit-1.61       |     1047 |      362 |          312 |     373 |      64% |
| p61-1.2              |        9 |        9 |            0 |       0 |     100% |
| palette              |        9 |        9 |            0 |       0 |     100% |
...
- **approximated** (312): `_app add icon`, `_app add menu`, `_app add wnd`, `_app rem icon`,
  `_app rem menu`, `_app rem wnd`, `_area draw`, `_area ellipse`, `_area end`, `_area move`,
  `_asl alloc`, `_asl do`, `_asl file$`, `_asl free`, `_asl what drawer`, `_asl what file`,
  `_asl what font`, `_asl what nb args`, `_base cx`, `_base iff`, `_base wb`, `_bd draw`,
  `_chunk child`, `_chunk current`, `_chunk end`, `_chunk parent`, `_chunk read`,
  `_chunk what id`, `_chunk what scan`, `_chunk what size`, `_chunk what type`, `_chunk write`,
  `_cli read args`, `_cli what arg`, `_cli what arg$`, `_cx broker`, `_cx disable`,
  ...
  `_cx id wait event`, `_cx init`, `_cx install`, `_cx msg port`, `_cx uninstall`, `_dos err`,
  `_dos report`, `_dos set err`, `_dos var del`, `_dos var find`, `_dos var value$`, `_dt add`,
  ...
  `_dt what triggers`, `_font add`, `_font ask`, `_font close`, `_font load`, `_font open`,
  `_font rem`, `_ggad create`, `_ggad set attrs`, `_gmn create`, `_gmn end`, `_gmn free`,
