...
- **approximated** (34): `gui actual`, `gui bank`, `gui bar`, `gui bbox`, `gui border`,
  `gui box`, `gui close`, `gui cls`, `gui clw`, `gui code`, `gui code$`, `gui draw`,
  `gui draw to`, `gui ellipse`, `gui event`, `gui exist`, `gui gfx`, `gui ink`, `gui lock`,
  `gui off`, `gui on`, `gui open`, `gui paint`, `gui paper`, `gui pen`, `gui plot`, `gui point`,
  `gui reset`, `gui selected`, `gui text`, `gui unlock`, `gui wait`, `gui window`, `gui writing`
