...
- **faithful** (128): `align`, `amcaf crack off`, `amcaf crack on`, `amos state`, `avail free`,
  ...
  `cd set`, `clear mouse`, `dev state`, `drive busy`, `drive state`, `even`, `explode base`,
  ...
  `hof`, `iff bank`, `image height`, `image swap`, `image width`, `ipk length`, `long`, `long$`,
  `lpk length`, `lpk unpack`, `lsl.b`, `lsl.l`, `lsl.w`, `lsr.b`, `lsr.l`, `lsr.w`, `number`,
  `odd`, `open workbench`, `pause`, `pcpn$`, `pcsr$`, `pdef$`, `pinv$`, `pjam$`, `plane active`,
  ...
  `ppk unpack`, `psad$`, `pund$`, `rastport`, `rs`, `rs aptr`, `rs bset`, `rs byte`, `rs char`,
  ...
  `softreset`, `stop loop`, `vectorptr`, `wait loop`, `wait mouse`, `word`, `word$`,
  `workbench`, `xpk crypt`, `xpk err$`, `xpk errn`, `xpk length`, `xpk name$`, `xpk pack`,
  `xpk unpack`
- **approximated** (1): `lpk pack`
- **missing** (2): `dpk name$`, `dpk unpack`
