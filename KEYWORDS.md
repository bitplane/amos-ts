...
- **approximated** (120): `gui activate`, `gui actual`, `gui aga`, `gui array`,
  `gui array down`, `gui array read`, `gui array up`, `gui bank`, `gui bar`, `gui bbox`,
  `gui beep`, `gui border`, `gui box`, `gui center`, `gui change`, `gui check`, `gui close`,
  `gui cls`, `gui clw`, `gui code`, `gui code$`, `gui draw`, `gui draw to`, `gui ellipse`,
  `gui event`, `gui exist`, `gui free zone`, `gui gad height`, `gui gad width`, `gui gadget`,
  `gui gfx`, `gui height`, `gui in height`, `gui in width`, `gui ink`, `gui kind`, `gui lock`,
  `gui menu`, `gui menu check`, `gui menu off`, `gui menu on`, `gui menu uncheck`,
  `gui monitor`, `gui mouse ex`, `gui mouse ey`, `gui mouse mode`, `gui mouse queue`,
  `gui mouse report`, `gui mouse wx`, `gui mouse wy`, `gui mouse x`, `gui mouse y`,
  `gui mouse zone`, `gui move`, `gui off`, `gui on`, `gui open`, `gui os`, `gui paint`,
  ...
  `gui pub to back`, `gui pub to front`, `gui range`, `gui read`, `gui read$`,
  `gui remember off`, `gui remember on`, `gui reserve zone`, `gui reset`, `gui resize`,
  `gui rmb`, `gui screen base`, `gui screen close`, `gui screen colours`, `gui screen depth`,
  `gui screen height`, `gui screen move`, `gui screen open`, `gui screen width`, `gui selected`,
  ...
  `gui title$`, `gui titles`, `gui to back`, `gui to front`, `gui unlock`, `gui wait`,
  `gui wait vbl`, `gui width`, `gui window`, `gui writing`, `gui x`, `gui x font`, `gui x gad`,
  `gui y`, `gui y font`, `gui y gad`, `gui zone`
