...
- **missing**: `@_apml_@`, `as`, `follow`, `follow off`, `hardcol`, `ldir`, `ldir/w`, `mask iff`, `picture`, `pload`, `prun`, `read text`, `save`, `save iff`, `set accessory`, `set hardcol`
