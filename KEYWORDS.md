...
- **approximated** (186): `gui activate`, `gui actual`, `gui aga`, `gui amiga os`,
  ...
  `gui y gad`, `gui zone`, `xfa check`, `xfa depth`, `xfa frames`, `xfa height`, `xfa mode id`,
