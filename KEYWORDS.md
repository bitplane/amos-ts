...
- **approximated** (95): `gui activate`, `gui actual`, `gui bank`, `gui bar`, `gui bbox`,
  ...
  `gui off`, `gui on`, `gui open`, `gui paint`, `gui paper`, `gui pause`, `gui pen`, `gui plot`,
  ...
  `gui x font`, `gui x gad`, `gui y`, `gui y font`, `gui y gad`, `gui zone`
