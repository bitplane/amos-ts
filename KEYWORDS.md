...
| gui-1.5b             |       48 |       22 |           26 |       0 |     100% |
| gui-1.61             |      103 |       50 |           53 |       0 |     100% |
| gui-2.10             |      204 |       85 |          119 |       0 |     100% |
| input                |       18 |       17 |            1 |       0 |     100% |
...
- **approximated** (26): `gui amiga`, `gui amos`, `gui asl font`, `gui asl screen`, `gui asl$`,
  `gui bank`, `gui border`, `gui circle`, `gui close`, `gui dir$`, `gui exist`, `gui file$`,
  `gui iconify`, `gui mouse x`, `gui mouse y`, `gui open`, `gui paste block`, `gui paste bob`,
  `gui paste icon`, `gui req`, `gui reset`, `gui screen open`, `gui scroll`, `gui set`,
  `gui uniconify`, `gui wait`

## gui-1.61 (100%)

- **approximated** (53): `gui amiga`, `gui amos`, `gui asl font`, `gui asl screen`, `gui asl$`,
  `gui bank`, `gui beep`, `gui border`, `gui close`, `gui dir$`, `gui event`, `gui exist`,
  `gui file$`, `gui gad adr`, `gui iconify`, `gui in height`, `gui in width`, `gui mouse x`,
  `gui mouse y`, `gui open`, `gui paste block`, `gui paste bob`, `gui paste icon`, `gui read`,
  `gui read$`, `gui req`, `gui reset`, `gui scroll`, `gui set`, `gui titles`, `gui uniconify`,
  `gui wait`, `tcp buffer`, `tcp channel`, `tcp check`, `tcp close`, `tcp code`, `tcp count`,
...
- **approximated** (119): `gui amiga os`, `gui app icon`, `gui app id`, `gui app name$`,
  ...
  `gui bbox`, `gui beep`, `gui best`, `gui border`, `gui catalog close`, `gui catalog open`,
  `gui catalog$`, `gui center`, `gui clip read$`, `gui clip write$`, `gui clone`, `gui close`,
  `gui dir$`, `gui display iff`, `gui event`, `gui exist`, `gui file$`, `gui font size`,
  `gui gad adr`, `gui gad tag`, `gui get$`, `gui guide`, `gui help`, `gui iconify`,
  `gui in height`, `gui in width`, `gui input$`, `gui line 3d`, `gui monitor`, `gui mouse mode`,
  `gui mouse queue`, `gui mouse report`, `gui mouse wx`, `gui mouse wy`, `gui mouse x`,
  `gui mouse y`, `gui notify`, `gui open`, `gui output`, `gui paste block`, `gui paste bob`,
  `gui paste icon`, `gui pub check`, `gui pub free`, `gui pub list`, `gui pub list free`,
  `gui pub mode`, `gui pub name$`, `gui pub screen`, `gui pub to back`, `gui pub to front`,
  `gui put`, `gui read`, `gui read$`, `gui rem notify`, `gui remap`, `gui req`, `gui reset`,
  `gui rgb`, `gui rmb`, `gui save iff`, `gui screen base`, `gui screen close`,
  `gui screen copy`, `gui screen move`, `gui screen open`, `gui scroll`, `gui selected`,
  `gui set`, `gui set mode`, `gui set$`, `gui show title`, `gui title$`, `gui titles`,
  `gui uniconify`, `gui user catalog`, `gui wait`, `tcp abort`, `tcp accept`, `tcp close`,
