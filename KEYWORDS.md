...
- **approximated** (204): `gui activate`, `gui actual`, `gui aga`, `gui amiga os`,
  ...
  `gui center`, `gui change`, `gui check`, `gui clip read$`, `gui clip write$`, `gui clone`,
  `gui close`, `gui cls`, `gui clw`, `gui code`, `gui code$`, `gui colour`, `gui dir$`,
  `gui display iff`, `gui draw`, `gui draw to`, `gui ellipse`, `gui event`, `gui exist`,
  `gui eye 3d`, `gui file$`, `gui font size`, `gui free zone`, `gui gad adr`, `gui gad height`,
  `gui gad tag`, `gui gad width`, `gui gadget`, `gui get$`, `gui gfx`, `gui green`, `gui guide`,
  `gui height`, `gui help`, `gui iconify`, `gui in height`, `gui in width`, `gui ink`,
...
- **approximated** (26): `wb bool gadget`, `wb close screen`, `wb close window`,
  `wb current window`, `wb event`, `wb flash screen`, `wb item`, `wb menu`, `wb menu item`,
  `wb menu on`, `wb menu sub item`, `wb menu title`, `wb move screen`, `wb move window`,
  `wb open screen`, `wb open window`, `wb screen base`, `wb screen flags`, `wb screen num`,
  `wb screen offset`, `wb sub item`, `wb titles`, `wb window base`, `wb window flags`,
  `wb window ids`, `wb window num`
