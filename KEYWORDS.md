...
1203 qualifying notes live in `src/coverage/status.ts`, which this file
...
- **approximated** (8): `dme sam freq`, `dme sam play`, `fc13 play`, `fc14 play`,
