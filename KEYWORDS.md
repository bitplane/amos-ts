...
| os-devkit-1.61       |     1047 |      360 |           41 |     646 |      38% |
| p61-1.2              |        9 |        9 |            0 |       0 |     100% |
| palette              |        9 |        9 |            0 |       0 |     100% |
...
- **approximated** (41): `_area draw`, `_area ellipse`, `_area end`, `_area move`, `_bd draw`,
  ...
  `_scr id cls`, `_scr id colour`, `_scr id ellipse`, `_scr id from pointer`,
  `_scr id gr locate`, `_scr id gr writing`, `_scr id ink`, `_scr id line`, `_scr id line to`,
  `_scr id plot`, `_scr id point`, `_scr id rect`, `_scr id set line`, `_scr id text`,
  `_wnd id bar`, `_wnd id close`, `_wnd id fill ellipse`, `_wnd id open`, `_wnd id paint`,
  `_wnd id scroll`
