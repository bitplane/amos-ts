...
1251 qualifying notes live in `src/coverage/status.ts`, which this file
...
- **approximated** (15): `db play`, `dme sam freq`, `dme sam play`, `fc13 play`, `fc14 play`,
  `omed play`, `ptm cia speed`, `s3m play`, `sfx13 play`, `sid play`, `smon play`, `tfmx play`,
  `thx cont`, `thx vu`, `xm play`
- **n/a** (1): `nop`
