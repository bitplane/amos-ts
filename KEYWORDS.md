...
| os-devkit-1.61       |     1047 |      362 |          177 |     508 |      51% |
| p61-1.2              |        9 |        9 |            0 |       0 |     100% |
| palette              |        9 |        9 |            0 |       0 |     100% |
...
- **approximated** (177): `_area draw`, `_area ellipse`, `_area end`, `_area move`, `_bd draw`,
  ...
  `_gt begin refresh`, `_gt boopsi`, `_gt button`, `_gt checkbox`, `_gt cycle`, `_gt disable`,
  `_gt enable`, `_gt end refresh`, `_gt gadgets attach`, `_gt gadgets bank`,
  `_gt gadgets erase`, `_gt gadgets remove`, `_gt h scroller`, `_gt h slider`, `_gt integer`,
  `_gt listview`, `_gt mx`, `_gt number`, `_gt palette`, `_gt refresh`, `_gt refresh wnd`,
  `_gt set attrs`, `_gt set checkbox`, `_gt set cycle`, `_gt set integer`,
  ...
  `_img draw`, `_img draw state`, `_img erase`, `_layer create behind`, `_layer create upfront`,
  `_layer delete`, `_li free`, `_li new`, `_menu clear`, `_menu off`, `_menu on`, `_menu set`,
  `_menu share`, `_menu what address`, `_menu what flags`, `_menu what item nb`,
