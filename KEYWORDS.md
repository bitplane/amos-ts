...
- **faithful** (127): `align`, `amcaf crack off`, `amcaf crack on`, `amos state`, `avail free`,
  ...
  `lpk length`, `lsl.b`, `lsl.l`, `lsl.w`, `lsr.b`, `lsr.l`, `lsr.w`, `number`, `odd`,
  `open workbench`, `pause`, `pcpn$`, `pcsr$`, `pdef$`, `pinv$`, `pjam$`, `plane active`,
  ...
  `xpk unpack`
- **missing** (4): `dpk name$`, `dpk unpack`, `lpk pack`, `lpk unpack`
