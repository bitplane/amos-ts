...
- `Doscall`/`Execall`/`Lib Open`/ARexx — host and ROM. (Speech and IOPorts
  used to be on this line; both are done, on narrator-ts and on the host's
  printer/serial capabilities.)
