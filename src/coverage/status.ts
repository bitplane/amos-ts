...
export const FAITHFUL = new Set<string>([
  ...
  '_base dt',
  '_base layers',
  // OS DevKit's exact 14-byte Exec List/Node layout and workers 1439-1465.
  '_lnod set head',
  '_lnod set tail',
  '_lnod set type',
  '_lnod alloc',
  ...
  '_nod what name',
  '_nod what start',
  // OS DevKit's Exec MsgPort/Message/signal/Interrupt workers 1534-1566 and
  // message reply-port worker 1796, over the shared mapped Exec service.
  '_port add',
  '_port rem',
  '_port find',
  '_port create',
  ...
  '_int set',
  '_int rem',
  // OS DevKit's private channel list/data-header workers 1122-1151.
  '_chn set number',
  '_chn set default',
  '_chn set first',
  '_chn set last',
  ...
  '_ta what style',
  '_ta what flags',
  // Native Border, Image, BooleanInfo and PropInfo records, workers 300-313
  // and 319-351. Rendering-only workers remain partial.
  '_bd set draw',
  '_bd set corner',
  '_bd set dots',
  '_bd set next',
  ...
  '_pi what left',
  '_pi what top',
  // Complete and partial StringInfo setters/readers, workers 352-369.
  '_si set buf',
  '_si set ext',
  '_si set integer',
  '_si set keymap',
  ...
  '_si what integer',
  '_si what keymap',
  // Native graphics records, ColorMaps, font state and synchronous blitter
  // ownership, workers 549/552, 562, 567-573, 584/588-589, 595-603 and
  // 620-674. RastPort drawing calls follow in the next slice.
  '_rgb4 get',
  '_rgb4 cm set',
  '_tmpras init',
  '_blt disown',
  ...
  '_rast alloc',
  '_rast free',
  // OS DevKit's private NewGadget defaults and direct GadTools ownership
  // wrappers, workers 1482-1497/1500-1509/1513. They use the Runtime's one
  // gadtools.library object space, shared with GUI and Int.
  '_ggad def body',
  '_ggad def text',
  '_ggad def id',
  '_ggad def flags',
  ...
  // and `$6` of the Intuition Window the design block points at. `Gui Border`
  // reads its four native border bytes; In Width/Height subtract those same
  // fields, including the title height selected by the screen font.
  //
  ...
  'wb bool gadget', 'wb gt gadget', 'wb gt string', 'wb set gt string', 'wb activate gt',
...
export const NOTES: Record<string, string> = {
  ...
  "td visible":
    "$211d64 reads the instance's culled-this-frame byte. Td Redraw reproduces the bounding-sphere tests at " +
    "$21904a..$219158 against the near, left, right, top and bottom frustum planes before visiting any face.",
  "td advanced":
