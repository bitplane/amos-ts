...
const AUDITED = new Map<string, { status: OsBackendStatus; reason: string }>([
  ...
  ['_dt create', { status: 'partial', reason: 'shared objects decode every installed picture and sound class plus FTXT; AmigaGuide class presentation is intentionally deferred' }],
  ...
  ['_dt what attrs', { status: 'partial', reason: 'generic, picture, sound and FTXT computed attributes write through caller pointers; native BitMap and layout objects remain incomplete' }],
