...
const AUDITED = new Map<string, { status: OsBackendStatus; reason: string }>([
  ...
  ['_dt do', { status: 'partial', reason: 'dispatches native frame-box, layout, removal, picture-draw, sound STM_PLAY and AmigaGuide DTM_GOTO messages; copy and write remain incomplete' }],
