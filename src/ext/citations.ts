...
export const CITED_BY: Record<string, string[]> = {
  ...
  'src/runtime/intuiextend.ts': ['intuiextend-2.01b'],
  'src/runtime/intuiextendsys.ts': ['intuiextend-2.01b'],
  'src/runtime/intuiextendgfx.ts': ['intuiextend-2.01b'],
  ...
  'src/runtime/intuiextendreq.ts': ['intuiextend-2.01b'],
  'src/runtime/intuiextendiff.ts': ['intuiextend-2.01b'],
  'src/runtime/intuiextendtd.ts': ['intuiextend-2.01b'],
  'src/runtime/intuiextendpp.ts': ['intuiextend-2.01b'],
  'src/runtime/intuiextendpp.test.ts': ['intuiextend-2.01b'],
  'src/runtime/intuiextendapp.ts': ['intuiextend-2.01b'],
  'src/runtime/intuiextendapp.test.ts': ['intuiextend-2.01b'],
  // both builds: the file is the difference between them, so a routine
  // number in it may be either one's
  'src/runtime/intuiextend16.ts': ['intuiextend-1.6', 'intuiextend-2.01b'],
  'src/runtime/intuiextend16.test.ts': ['intuiextend-1.6', 'intuiextend-2.01b'],
  ...
  'src/runtime/thegame.ts': ['the-game-0.9'],
  'src/runtime/thegame.test.ts': ['the-game-0.9'],
  ...
  'src/runtime/maxsdoor.ts': ['maxsdoor-0.20'],
  'src/runtime/maxsdoor.test.ts': ['maxsdoor-0.20'],
  'src/runtime/symbase.ts': ['symbase-0.94', 'dbench-0.42'],
