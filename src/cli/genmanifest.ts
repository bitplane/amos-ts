...
function area(name: string): string {
  ...
  const map: Record<string, string> = {
    ...
    dialog: 'interface', vdialog: 'interface', rdialog: 'interface', edialog: 'interface',
    zdialog: 'interface', choice: 'interface', fsel$: 'interface', psel$: 'interface',
    hslider: 'interface', vslider: 'interface', resource: 'interface',
