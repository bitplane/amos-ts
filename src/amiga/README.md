...
| `datatypes.ts` | `datatypes.library`: DTHD matching plus shared object, attribute, method and window-attachment lifecycle |
| `datatypes.gen.ts` | the ten Workbench 3.0 descriptors, generated by `src/cli/gendatatypes.ts` |
| `datatype-text.ts` | IFF FTXT character chunks and AmigaGuide source |
| `iff8svx.ts` | IFF 8SVX mono/stereo PCM and Fibonacci delta compression |
...
| `gif.ts` | GIF87a/GIF89a indexed pictures, LZW, interlace and transparency |
