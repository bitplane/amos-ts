...
export const XADFIF = {
  ...
  SEEKDATAPOS: 1 << XADFIB.SEEKDATAPOS,
  NOFILENAME: 1 << XADFIB.NOFILENAME,
  NOUNCRUNCHSIZE: 1 << XADFIB.NOUNCRUNCHSIZE,
  PARTIALFILE: 1 << XADFIB.PARTIALFILE,
  MACDATA: 1 << XADFIB.MACDATA,
  MACRESOURCE: 1 << XADFIB.MACRESOURCE,
  EXTRACTONBUILD: 1 << XADFIB.EXTRACTONBUILD,
  UNIXPROTECTION: 1 << XADFIB.UNIXPROTECTION,
  DOSPROTECTION: 1 << XADFIB.DOSPROTECTION,
  ENTRYMAYCHANGE: 1 << XADFIB.ENTRYMAYCHANGE,
  XADSTRFILENAME: 1 << XADFIB.XADSTRFILENAME,
  XADSTRLINKNAME: 1 << XADFIB.XADSTRLINKNAME,
  XADSTRCOMMENT: 1 << XADFIB.XADSTRCOMMENT,
} as const
