...
Programs identified to each extension across 6574 readable programs
(3673 of them use an extension at all), one program at a time.

125 further program(s) could not be parsed and are not counted here.
...
| -------: | -------------------------- | ----------------- | ----------------: |
|     2346 | `amospro-music-2.0`        | module            |           49 / 49 |
|     1673 | `amospro-compact-2.0`      | core              |             3 / 3 |
|      161 | `turbo-plus-1.9`           | module            |           87 / 87 |
|      132 | `amcaf-1.40`               | module            |         268 / 268 |
|      116 | `amospro-request-2.0`      | core              |             3 / 3 |
|      108 | `ldos-2.5`                 | module            |           77 / 77 |
|       92 | `personal-1.0b`            | module            |         108 / 108 |
|       80 | `amos3d-1.0`               | module            |           64 / 64 |
|       75 | `amospro-compiler-2.0`     | part              |            8 / 15 |
|       62 | `turbo-plus-1.0`           | module            |         134 / 134 |
|       51 | `easylife-1.09`            | module            |         156 / 156 |
|       50 | `jd-4.6`                   | module            |         125 / 125 |
|       37 | `amospro-ioports-2.0`      | module            |           38 / 38 |
|       28 | `intuition-1.3b`           | part              |           2 / 183 |
|       18 | `jd-5.3`                   | module            |         130 / 130 |
|       16 | `amcaf-1.50`               | module            |         280 / 280 |
|       16 | `dme-2.0`                  | module            |         151 / 184 |
|       16 | `tome-4.23`                | module            |           67 / 67 |
|       16 | `int-1.0`                  | —                 |            0 / 62 |
|       15 | `tft-0.6`                  | module            |           22 / 22 |
|       14 | `maxsdoor-0.20`            | module            |           21 / 21 |
...
|        8 | `craft-1.0`                | module            |         138 / 138 |
|        8 | `make-1.30`                | module            |           32 / 32 |
|        7 | `gui-1.61`                 | module            |         103 / 103 |
|        6 | `orgasm-1.0`               | —                 |            0 / 13 |
|        5 | `stars-2.33`               | module            |           11 / 11 |
|        4 | `gui-1.5b`                 | module            |           48 / 48 |
|        4 | `tft-0.7`                  | module            |           28 / 28 |
|        4 | `tome-3.1`                 | module            |           33 / 34 |
|        4 | `aga-1.0`                  | module            |           24 / 24 |
|        3 | `musicraft-1.0`            | module            |           12 / 12 |
|        3 | `gui-2.10`                 | module            |         204 / 204 |
|        3 | `d-sam-1.01`               | —                 |            0 / 50 |
|        3 | `jvp-1.01`                 | module            |           11 / 11 |
|        2 | `opal-1.1`                 | module            |           78 / 78 |
