...
58 extensions are registered, 5 of them stock.
...
| `jd-5.3` | JD | source | 130 | — | — |
| `personal-1.0b` | Personnal Extension | source | 110 | 13 | — |
...
| `amospro-ioports-2.0` | IOPorts | source | 39 | 6 | stock, slot 6 |
...
| `amcaf-1.50` | AMCAF | manual | 281 | — | recommends 8 |
| `gui-2.10` | GUI | manual | 204 | — | recommends 24 |
| `easylife-1.10` | Easy Life | manual | 160 | — | recommends 16 |
| `turbo-plus-2.15` | TURBO Plus | manual | 152 | — | — |
| `jd-5.9` | JD | manual | 133 | — | recommends 22 |
| `personnal-1.1` | Personnal | manual | 128 | 13 | — |
...
| `jd-int-1.3` | JD Intuition | manual | 34 | — | recommends 18 |
